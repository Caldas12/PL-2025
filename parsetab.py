...
_lr_goto_items = {'program':([0,],[1,]),'statement_list':([0,49,],[2,62,]),'statement':([0,2,49,62,],[3,28,3,28,]),'import_table':([0,2,49,62,],[4,4,4,4,]),'export_table':([0,2,49,62,],[5,5,5,5,]),'discard_table':([0,2,49,62,],[6,6,6,6,]),'rename_table':([0,2,49,62,],[7,7,7,7,]),'print_table':([0,2,49,62,],[8,8,8,8,]),'select_table':([0,2,48,49,62,],[9,9,59,9,9,]),'create_table_select':([0,2,49,62,],[10,10,10,10,]),'create_table_join':([0,2,49,62,],[11,11,11,11,]),'create_table_from_select_columns':([0,2,49,62,],[12,12,12,12,]),'procedure':([0,2,49,62,],[13,13,13,13,]),'call_procedure':([0,2,49,62,],[14,14,14,14,]),'select_columns':([0,2,48,49,62,],[21,21,21,21,21,]),'select_where':([0,2,48,49,62,],[22,22,22,22,22,]),'select_where_and':([0,2,48,49,62,],[23,23,23,23,23,]),'select_limit':([0,2,48,49,62,],[24,24,24,24,24,]),'comma_id':([20,46,61,],[36,57,71,]),'operator':([75,97,],[80,99,]),'select_and':([90,100,],[94,102,]),}
...
_lr_productions = [
  ...
  ('select_columns -> SELECT comma_id FROM ID SEMICOLON','select_columns',5,'p_select_columns','parser.py',85),
  ('select_where -> SELECT STAR FROM ID WHERE ID operator ID SEMICOLON','select_where',9,'p_select_where','parser.py',89),
  ('select_where_and -> SELECT STAR FROM ID WHERE ID operator ID select_and','select_where_and',9,'p_select_where_and','parser.py',93),
  ('select_and -> AND ID operator ID SEMICOLON','select_and',5,'p_select_and','parser.py',97),
  ('select_and -> AND ID operator ID select_and','select_and',5,'p_select_and','parser.py',98),
  ('select_limit -> SELECT STAR FROM ID LIMIT NUMBER SEMICOLON','select_limit',7,'p_select_limit','parser.py',105),
  ('comma_id -> ID COMMA comma_id','comma_id',3,'p_comma_id','parser.py',109),
  ('comma_id -> ID','comma_id',1,'p_comma_id','parser.py',110),
  ('create_table_select -> CREATE TABLE ID select_table','create_table_select',4,'p_create_table_select','parser.py',119),
  ('create_table_join -> CREATE TABLE ID FROM ID JOIN ID USING ID SEMICOLON','create_table_join',10,'p_create_table_join','parser.py',123),
  ('create_table_from_select_columns -> CREATE TABLE ID SELECT comma_id FROM ID SEMICOLON','create_table_from_select_columns',8,'p_create_table_from_select_columns','parser.py',127),
  ('procedure -> PROCEDURE ID DO statement_list END SEMICOLON','procedure',6,'p_procedure','parser.py',133),
  ('call_procedure -> CALL ID SEMICOLON','call_procedure',3,'p_call_procedure','parser.py',137),
]
